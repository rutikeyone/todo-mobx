...
Future<void> setup(DIContainer diContainer) async {
  await _initHive();
  await _initNotificationService(diContainer);
...
Future _initNotificationService(DIContainer diContainer) async {
  locator.registerSingleton<NotificationService>(
      diContainer.makeNotificationService());
  await locator.get<NotificationService>().init();
}
